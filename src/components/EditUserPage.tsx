  ...
  return (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mt-8">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Merchant Info : 711809029705305760</h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 space-x-1">
                      <button
                        type="button"
                        onClick={() => alert('Merchant Key: test_merchant_key_123')}
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          navigator.clipboard.writeText('test_merchant_key_123');
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        navigator.clipboard.writeText('test_merchant_salt_456');
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        navigator.clipboard.writeText('test_Zg6uM');
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        navigator.clipboard.writeText('svvYxPCo0v');
